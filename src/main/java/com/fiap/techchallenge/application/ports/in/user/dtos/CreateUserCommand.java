...
public record CreateUserCommand(@NotBlank(message = "Name cannot be blank") String name,
        ...
        String address, @NotNull(message = "User type cannot be null") UserType type) {
}